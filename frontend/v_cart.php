                            ...
                            <div class="card-body" id="cart-card">
                                ...
                                <div class="row item">
                                    <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                                        ...
                                        <div class="bg-image hover-overlay hover-zoom ripple rounded"
                                            ...
                                            <img src="../assets/book-12.jpeg" class="w-100" alt="Album" />
                                            <a href="#!">
                                                <div class="mask" style="background-color: rgba(238, 13, 13, 0.2)">
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="row item">
                                    <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                                        ...
                                        <div class="bg-image hover-overlay hover-zoom ripple rounded"
                                            data-mdb-ripple-color="light">
                                            <img src="../assets/book-16.jpeg" class="w-100" />
                                            <a href="#!">
                            ...
                            <div class="card-body" id="wishlist-card">
                                ...
                                <div class="row item">
                                    <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                                        ...
                                        <div class="bg-image hover-overlay hover-zoom ripple rounded"
                                            data-mdb-ripple-color="light">
                                            <img src="../assets/bts-album-suga-agust-d-tour-d-day-the-original-37706295804085_1000x.jpeg"
                                                class="w-100" alt="Album" />
                                            <a href="#!">
                                                <div class="mask" style="background-color: rgba(238, 13, 13, 0.2)">
                                                </div>
                                            </a>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-primary btn-lg btn-block"
                                    style="background-color: #7D009E" data-bs-toggle="modal"
