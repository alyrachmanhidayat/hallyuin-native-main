                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0 align-items-center">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="https://img.freepik.com/free-vector/login-concept-illustration_114360-739.jpg?t=st=1717919507~exp=1717923107~hmac=9f1288beace4ca8df20db3c23c32952e68b7a644e49274fef4f8afdc7aff0bac&w=740" alt="login form" class="img-fluid " style="border-radius: 1rem 0 0 1rem;" />
                            </div>
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form>
                                        ...
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            <input type="password" id="form2Example27" class="form-control form-control-lg" placeholder="Type Your password here!" />
                                        ...
                                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="v_register.php" style="color: #393f81;">Register here</a></p>
                                        <a href="#!" class="small text-muted">
                                            <div class="">
                                                <span class="small material-symbols-outlined">
                                                    Copyright
                                                </span>
                                                2024 Hallyuin
                                            </div>
