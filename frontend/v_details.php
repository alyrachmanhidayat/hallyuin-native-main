...
<head>
    ...
    <link href="/hallyuin-native-main/css/product_details.css" rel="stylesheet" type="text/css">
                    ...
                    <div class="product-image">
                        <div id="myCarousel-2" class="carousel slide">
                            <ol class="carousel-indicators">
                                ...
                                <li data-target="#myCarousel-2" data-slide-to="3" class="active"></li>
                                <li data-target="#myCarousel-2" data-slide-to="4" class></li>
                            </ol>
                            <div class="carousel-inner">

                                <div class="item active">
                                    <img src="\hallyuin-native-main\assets\book-2.jpeg" class="img-responsive" alt />
                                </div>

                                <div class="item">
                                    <img src="\hallyuin-native-main\assets\book-3.jpeg" class="img-responsive" alt />
                                </div>

                                <div class="item">
                                    <img src="\hallyuin-native-main\assets\book-4.jpeg" class="img-responsive" alt />
                                </div>

                                <div class="item">
                                    <img src="\hallyuin-native-main\assets\book-5.jpeg" class="img-responsive" alt />
                                </div>

                                <div class="item">
                                    <img src="\hallyuin-native-main\assets\book-6.jpeg" class="img-responsive" alt />
                                </div>
                            </div>
